...
#ifndef TARGET_IRQ_CONFIG_H_
#define TARGET_IRQ_CONFIG_H_
...
// CCU61 通道0/1：当前不用，宏保留给逐飞驱动源码编译，优先级置 0 关闭。
//================================ PIT Interrupt Parameters ================================
...
// 通道0/1/4/5 当前不用，宏保留给逐飞驱动源码编译，优先级置 0 关闭。
...
//================================ UART Interrupts ================================
// 串口0~3 均由 CPU0 处理；当前只保留 RX/ER 入口，TX 优先级置 0 关闭。
// 错误中断 ER 比 RX 略高，确保错误状态被及时清除不阻塞通讯。
// 串口分配：UART0=调试，UART1=摄像头配置，UART3=无线。
