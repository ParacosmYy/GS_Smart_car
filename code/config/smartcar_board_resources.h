 ...
 *
 * 本文件属于产品配置，HAL 公共接口不引用此文件。
 */

#include "hal/hal.h"

/* ── PWM 通道 ────────────────────────────────────────── */
typedef smartcar_hal_pwm_id_t smartcar_pwm_id_t;
...
/* ── GPIO 引脚 ───────────────────────────────────────── */
typedef smartcar_hal_gpio_id_t smartcar_gpio_id_t;
...
/* ── 编码器通道 ──────────────────────────────────────── */
typedef smartcar_hal_encoder_id_t smartcar_encoder_id_t;
...
/* ── PIT 周期中断通道 ────────────────────────────────── */
typedef smartcar_hal_pit_id_t smartcar_pit_id_t;
...
/* ── UART 串口通道 ───────────────────────────────────── */
typedef smartcar_hal_uart_id_t smartcar_uart_id_t;
